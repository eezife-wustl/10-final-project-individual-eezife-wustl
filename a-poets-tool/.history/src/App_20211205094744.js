...
class App extends Component {
  ...
  handleChange(event) {
    ...
    //love, nature, gratitude, humor, joy, passion, nostalgia, optimism, contentment, boredom, pessimism, frustration
    ...
    let myRequest = new Request("https://api.datamuse.com/words?ml=love&max=1000");
