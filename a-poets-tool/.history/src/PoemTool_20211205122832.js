...
class PoemTool extends Component {
  ...
  render () {
    return (
      ...
      {/* <select className="form-select form-select-lg" aria-label="Default select example" id="PoemTopic" onChange={this.props.onClick} value={this.props.myPoemTopic}>
      ...
      <Form.Select className="form-select form-select-lg" aria-label="Default select example" id="PoemTopic" onChange={this.props.onClick} value={this.props.myPoemTopic}>
          <option value="Pick For Me">Pick For Me</option>
          <option value="Love">Love</option>
          <option value="Nature">Nature</option>
          <option value="Gratitde">Gratitde</option>
          <option value="Humor">Humor</option>
