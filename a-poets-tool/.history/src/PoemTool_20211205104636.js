...
class PoemTool extends Component {
  ...
  render () {
    return (
      ...
      <select className="form-select form-select-lg" aria-label="Default select example" id="PoemTopic" onChange={this.handleChange} >
          <option selected value="">Pick For Me</option>
