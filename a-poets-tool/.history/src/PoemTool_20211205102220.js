...
class PoemTool extends Component {
  ...
  render () {
    return (
      ...
      <select className="form-select form-select-lg" aria-label="Default select example" id="PoemTopic">
          ...
          <option value="3">Pessimism</option>
          <option value="3">Frustration</option>
        </select>
    </div>
    );
  }
