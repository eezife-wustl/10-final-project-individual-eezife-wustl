...
class Header extends Component {
  render () {
    return (
      ...
      <header>
      <nav className="navbar navbar-expand-md navbar-light fixed-top static-top-1 bg-light" id="poetsToolBox">
          <div className="container justify-content-center">
            <a className="navbar-brand" href="index.html">A POET'S TOOL.</a>
              {/* <NavLink to="/">Home</NavLink> */}
          </div>
      </nav>
      <nav className="navbar navbar-expand-md fixed-top static-top-2 bg-dark">
          <div className="container justify-content-center">
