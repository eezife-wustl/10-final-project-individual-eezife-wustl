...
class App extends Component {
  ...
  handleSubmit(event) {
    ...
    if (this.state.myPoemTopic === "Pick For Me") {
      myRequest = new Request("https://api.datamuse.com/words?topics="+this.state.randomPoemTopic[Math.floor(Math.random() * this.state.poemForms.length)]+"&max=1000");
      console.log("https://api.datamuse.com/words?topics="+this.state.myPoemTopic+"&max=1000");
    }
    else {
