...
class App extends Component {
  ...
  handleSubmit(event) {
    ...
    this.setState({randomPoemWords: 
    console.log(_.shuffle(this.state.myPoemWords).slice(0,10));
      ...
      <div className="App"> 
              ...
              <div className="container">
                <div className="row"> 
                  ...
                  {/* {
                    if (this.state.myPoemWords.length > 0) {
                    this.pickRandomWords(this.state.myPoemWords).map((words) => 
