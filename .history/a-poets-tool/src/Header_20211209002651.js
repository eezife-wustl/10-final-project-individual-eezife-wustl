    ...
    return (
      ...
      <nav className="navbar navbar-expand-md static-top-0 static-top-2 bg-dark">
          ...
          <NavDropdown title="NEED MORE RESOURCES?" id="nav-dropdown">
            ...
            <NavDropdown.Item eventKey="4.2"> <a href="https://aprweb.org/"> The American Poetry Review </a> </NavDropdown.Item>
            <NavDropdown.Item eventKey="4.3"> <a href="https://aprweb.org/"> The American Poetry Review </a> </NavDropdown.Item>
          </NavDropdown>
