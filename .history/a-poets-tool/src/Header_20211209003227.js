    ...
    return (
      ...
      <nav className="navbar navbar-expand-md static-top-0 static-top-2 bg-dark">
          ...
          <NavDropdown title="NEED MORE RESOURCES?" id="nav-dropdown">
            <NavDropdown.Item href="https://aprweb.org/"> The American Poetry Review </NavDropdown.Item>
            <NavDropdown.Item href="https://lithub.com/"> LitHub </NavDropdown.Item>
            <NavDropdown.Item href="https://www.poetryfoundation.org/"> <a href="https://www.poetryfoundation.org/"> Poetry Foundation </a> </NavDropdown.Item>
            <NavDropdown.Item eventKey="4.4"> <a href="https://poets.org/"> Academy of American poets </a> </NavDropdown.Item>
          </NavDropdown>
